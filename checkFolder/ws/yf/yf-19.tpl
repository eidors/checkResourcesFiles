...
<li class="nav_li"><a class="on" href="">研发中心</a>   
...
<div id="overlay">  
   ...
   <!-- -->
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>产品研发</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="about-1.html">研发中心</a>&nbsp;&#8211;&nbsp;产品研发</div>
        </div>
		
        <div id="mainc">&nbsp
<p class="MsoNormal">
	<span style="font-family:宋体">一体化环保节能外墙装饰材料，本产品正在接受住建部的最后测试。</span> 
</p>
<p class="MsoNormal">
	&nbsp
</p>
<p class="MsoNormal">
	智能公章管理系统已研制成功，本产品正在做最后调试，预计今年可上市销售。
</p></div>
