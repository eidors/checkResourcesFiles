...
<div id="overlay">  
   ...
   <!-- -->
	<div class="othersmenu fl">
       ...
       <div class="menu">
         <ul>
             ...
             <li><a href="" class='tit'>董事会成员</a></li>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>董事会</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="about-1.html">集团概况</a>&nbsp;&#8211;&nbsp;董事会</div>
        </div>
		
        <div id="mainc"><p align="center">
	<img alt="" src="static/picture/20150323104374847484.jpg">
</p>
<p>
	&nbsp
</p></div>
