   ...
   <!-- -->
	<div class="othersmenu fl">
       ...
       <div class="menu">
        ...
        <li><a href="aq-24.html" title="站外导航" class='tit'>站外导航</a></li>
        <li><a href="" title="版权所有" class='tit'>版权所有</a></li>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>版权所有</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="aq-22.html">网站说明</a>&nbsp;&#8211;&nbsp;版权所有</div>
        </div>
		
        <div id="mainc"><span style="background-color:#f7f5f4">“娲石”一词及各个娲石标志均为娲石集团的商标。所采用的商标及标志均属娲石集团的财产。网站上出现的其他名字可能属于有关其他拥有人的商标。本网站所提到或使用的产品、技术或程式的权利可能是由娲石集团或其他第叁者所保留，并无于此就该等知识产权提供任何许可。任何使用本网站人士不得在未有华润的书面许可的情况下分发、修改、传送或使用本网站的任何内容作公众或商业用途。</span><span style="color:#575656background-color:#f7f5f4">&nbsp</span></div>
...
<div class="gotopbox">
    ...
    <ul>
        ...
        <li>|</li>
        <li><a href="" title="版权所有">版权所有</a></li>
        <li>|</li>
