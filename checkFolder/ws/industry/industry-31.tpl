...
<div id="overlay">  
   ...
   <!-- -->
       ...
       <div class="menu">
         <ul>
				   ...
				   <li><a href="industry-32.html" class='tit'>武汉娲石商砼有限公司</a></li>
				    <li><a href="" class='tit'>武汉市阳逻通达水运有限公司</a></li>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>武汉通达水运有限公司</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="#">集团产业</a>&nbsp;&#8211;&nbsp;<a href="#">武汉通达水运有限公司</a></div>
        </div>
		
        <div id="mainc"><p style="text-indent:21pt" class="MsoNormal">
	<span style="font-family:宋体">
	<p class="MsoNormal" style="text-indent:28.0000pt">
		<span style="font-size:16px">武汉市通达船舶制造有限公司占地面积</span><span style="font-size:16px">150</span><span style="font-size:16px">亩，拥有万吨级船位</span><span style="font-size:16px">2</span><span style="font-size:16px">个，</span><span style="font-size:16px">5000</span><span style="font-size:16px">吨船位</span><span style="font-size:16px">4</span><span style="font-size:16px">个，</span><span style="font-size:16px">5000</span><span style="font-size:16px">吨以下船位</span><span style="font-size:16px">6</span><span style="font-size:16px">个，公司配有专用舾装码头。公司成立于</span><span style="font-size:16px">2005</span><span style="font-size:16px">年</span><span style="font-size:16px">10</span><span style="font-size:16px">月，以水路运输为主的物流运输公司，公司以诚信立业，多次获得武汉市</span><span style="font-size:16px">“</span><span style="font-size:16px">重合同守信用单位</span><span style="font-size:16px">”</span><span style="font-size:16px">、</span><span style="font-size:16px">“</span><span style="font-size:16px">安全生产优秀企业</span><span style="font-size:16px">”</span><span style="font-size:16px">、</span><span style="font-size:16px">“</span><span style="font-size:16px">新风船</span><span style="font-size:16px">”</span><span style="font-size:16px">等荣誉。</span>
	</p>
</span>
</p>
...
<p align="center">
	<img alt="" src="static/picture/20181008155356965696.png" width="700" height="466">&nbsp
</p>
<p align="center">
	<img alt="" src="http://www.hb-ws.cn/admin/kindeditor/attached/image/20181008/20181008155582838283.png" width="700" height="445"> 
</p>
<p align="center">
