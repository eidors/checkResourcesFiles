...
<li class="nav_li"><a class="on" href="news-14830_1.html">新闻中心</a>
				   ...
				   <li><a href="" class='tit'>环境信息公开</a></li>
  ...
  <div class="otherswrap" id="discover">
    <div class="layout"> 
      ...
      <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>行业新闻</h2>
          <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="javascript:;">新闻中心</a>&nbsp;&#8211;&nbsp;行业新闻</div>
        </div>
        <div id="mainc">
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s2021524151118.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">娲石集团阳新片区2020年1/2/3/4季度环境监测报告</div>
              <div class="news_text_detail"> <a href="detail-460.html" target="_blank">
                娲石集团阳新片区2020年1/2/3/4季度环境监测报告详细内容请点击此处查看....
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/nopic.jpg" width="150" height="150">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">2021年武汉港林四房港区娲石码头改扩建工程环境影响报告书征求意见稿公示</div>
              <div class="news_text_detail"> <a href="detail-455.html" target="_blank">
                武汉港林四房港区娲石码头改扩建工程环境影响报告书征求意见稿公示
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s2020510195328.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">2019年度阳新娲石水泥有限公司温室气体排放核查报告公示</div>
              <div class="news_text_detail"> <a href="detail-435.html" target="_blank">
                2019年度阳新娲石水泥有限公司温室气体排放核查报告公示详细内容请点击此处查看..........
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            ...
            <div class="news_text">
              <div class="news_text_name">2019年度阳新娲石水泥有限公司社会责任报告公示</div>
              <div class="news_text_detail"> <a href="detail-434.html" target="_blank">
                企业社会责任是中国经济发展企业做强做大的必然要求。随着科技的进步和经济的发展，企业产品本身在功能、外形等方面的同质化日益加深的情况下，企业社会责任已经成为价格、质量之后参与市场竞争的核心竞争力之一，因此，企业社会责任可以转化为发展机遇，不但可以创造直接的市场机会，还可以提升企业形...
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s20191230161935.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">2019年娲石水泥集团有限公司环境信息公示</div>
              <div class="news_text_detail"> <a href="detail-429.html" target="_blank">
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s2019325181651.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">2018年度阳新娲石水泥有限公司温室气体排放核查报告公示</div>
              <div class="news_text_detail"> <a href="detail-386.html" target="_blank">
          ...
          <div id="p_page">
            <font face="webdings">7</font> <strong>[1]</strong> <a href='news-2_2_1.html'>[2]</a> <a href='news-2_3_1.html'>[3]</a> 页 <font face="webdings">8</font>1/3&nbsp;&nbsp;页面跳转：
            <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
              <option value="?class=2&page=1&section=1" selected="">1/3</option><option value="?class=2&page=2&section=1">2/3</option><option value="?class=2&page=3&section=1">3/3</option>
            </select>
          </div>
        </div>
      </div>
