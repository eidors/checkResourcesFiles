        ...
        <div id="mainc">
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s2019325154531.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">阳新娲石水泥有限公司2018年度社会责任报告公示</div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s20181114141058.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">武汉港林四房港区娲石码头改扩建工程环境影响评价第一次公示</div>
              <div class="news_text_detail"> <a href="javascript:;" target="_blank">
                武汉港林四房港区娲石码头改扩建工程环境影响评价第一次公示，详细内容请点击此处查看...........
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            ...
            <div class="news_text">
              <div class="news_text_name">阳新娲石水泥有限公司2017年度社会责任报告公示</div>
              <div class="news_text_detail"> <a href="javascript:;" target="_blank">
          ...
          <div class="newsk">
            ...
            <div class="news_text">
              <div class="news_text_name">商品混凝土搅拌站项目建设项目竣工环境保护验收公示(2018年9月5日）</div>
              <div class="news_text_detail"> <a href="javascript:;" target="_blank">
                商品混凝土搅拌站项目建设项目竣工环境保护验收(2018年9月5日）
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            ...
            <div class="news_text">
              <div class="news_text_name">阳新娲石水泥有限公司2017年度温室气体排放核查报告</div>
              <div class="news_text_detail"> <a href="javascript:;" target="_blank">
                阳新娲石水泥有限公司2017年度温室气体排放核查报告详细内容请点击此处查看......
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s201711710411.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">阳新娲石水泥有限公司2016年度温室气体排放核查报告.</div>
              <div class="news_text_detail"> <a href="javascript:;" target="_blank">
                阳新娲石水泥有限公司2016年度温室气体排放核查报告详细内容请点击此处查看.........
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div id="p_page">
            <font face="webdings">7</font> <a href='javascript:;'>[1]</a> <strong>[2]</strong> <a href='news-2_3_1.html'>[3]</a> 页 <font face="webdings">8</font>2/3&nbsp;&nbsp;页面跳转：
            <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
              <option value="?class=2&page=1&section=1">1/3</option><option value="?class=2&page=2&section=1" selected="">2/3</option><option value="?class=2&page=3&section=1">3/3</option>
            </select>
          </div>
        </div>
      </div>
