  ...
  <div class="otherswrap" id="discover">
    <div class="layout"> 
      ...
      <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>职工之声</h2>
          <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="javascript:;">新闻中心</a>&nbsp;&#8211;&nbsp;职工之声</div>
        </div>
        <div id="mainc">
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s2015911144440.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">父母的爱情故事</div>
              <div class="news_text_detail"> <a href="detail-194_14830.html" target="_blank">
                我能想到最浪漫的事，就是看你们一起慢慢变老，一路上收藏点点滴滴的欢笑，留到以后坐着摇椅，慢慢摇……
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s201591111216.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">安全在我心中 安全伴我同行</div>
              <div class="news_text_detail"> <a href="detail-193_14830.html" target="_blank">
                为了生命的多姿多彩，为了家庭的圆满幸福，为了所有可爱的生灵，让我们一起牢记：安全在我心中，安全伴我同行。
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s201591114432.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">我们的小爱情</div>
              <div class="news_text_detail"> <a href="detail-23_14830.html" target="_blank">
                从相识、相知、相恋到结婚，这么多年里我们都改变了很多，而不管世事如何变迁，不管我如何改变，他一直都在。
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s2015911141516.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">让幸福像花儿一样绽放</div>
              <div class="news_text_detail"> <a href="detail-22_14830.html" target="_blank">
                四季轮回中，最是期盼春暖花开的时节。很喜欢在云淡风轻的日子里，以诗意的情怀，尽情地去感受春天的美好。
          ...
          <div class="newsk">
            ...
            <div class="news_text">
              <div class="news_text_name">不要让爱再等待</div>
              <div class="news_text_detail"> <a href="detail-21_14830.html" target="_blank">
                人生中最大的遗憾，莫过于子欲养而亲不待。母亲在时光里一天天变老，有时间就多陪陪我们的母亲吧，不要让爱再等待了。
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="newsk">
            ...
            <div class="news_text">
              <div class="news_text_name">诗样的人生</div>
              <div class="news_text_detail"> <a href="detail-20_14830.html" target="_blank">
                我以为从生物学的观点看起来，人生几乎是像一首诗。它有韵律和拍子，也有生长和腐蚀的内在循环。它开始是天真朴实的童年时期，嗣后便是粗拙的青春时期，企图去适应成熟的社会，带着青年的热情和愚憨，理想和野心，后来达到一个活动较剧烈的成年时期，由经验上获得进步，又由社会及人类天性上获得更多的...
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div id="p_page">
            ...
            <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
              <option value="?class=4&page=1&section=1" selected="">1/1</option>
            </select>
          </div>
        </div>
      </div>
