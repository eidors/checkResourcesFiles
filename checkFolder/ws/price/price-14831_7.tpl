...
<div id="overlay">  
   ...
   <!-- -->
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>产品介绍</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="price-14831_6.html">产品服务</a>&nbsp;&#8211;&nbsp;产品介绍</div>
        </div>
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-107_14831.html" target="_blank">
	
	 <img src="static/picture/s2014111792820.jpg" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-108_14831.html" target="_blank">
	
	 <img src="static/picture/s2014111795732.jpg" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-109_14831.html" target="_blank">
	
	 <img src="static/picture/s20141117162247.jpg" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-110_14831.html" target="_blank">
	
	 <img src="static/picture/s20141117163014.jpg" border="0">
   ...
   <div class="clearx"></div>
    ...
    <font face="webdings">7</font> <strong>[1]</strong> 页 <font face="webdings">8</font>1/1&nbsp;&nbsp;页面跳转：
                  <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
                      <option value="?class=7&page=1&section=1" selected="">1/1</option>
                  </select>
