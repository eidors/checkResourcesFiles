...
<li class="nav_li"><a class="on" href="yf-19.html">研发中心</a>   
				...
				<li class="nav_li"><a class="on" href="">产品服务</a>  
...
<div class="other-topimgx" id="featured">
    <div id="slider">
        <ul>
...
<div id="overlay">  
   ...
   <!-- -->
	<div class="othersmenu fl">
       ...
       <div class="menu">
         <ul>
				   ...
				   <li><a href="price-14831_7.html" class='tit'>产品介绍</a></li>
				   <li><a href="price-14831_8.html" class='tit'>新产品及价格预告</a></li>
         </ul>
        </div>
    </div>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>成功案例</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="">产品服务</a>&nbsp;&#8211;&nbsp;成功案例</div>
        </div>
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-93.html" target="_blank">
	
	 <img src="static/picture/s20141024162849.jpg" border="0">
     
	 </a>
	 </div>
	 <div class="newsx_text">
	        
	         <div class="newsx_text_detail">
		     <a href="detail-93.html" target="_blank">
	       阳逻东部产业园
		          </a>
	         </div>
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-95.html" target="_blank">
	
	 <img src="static/picture/s2014102416422.jpg" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-97.html" target="_blank">
	
	 <img src="static/picture/s2015923165136.JPG" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-105.html" target="_blank">
	
	 <img src="static/picture/s201592317057.JPG" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-165.html" target="_blank">
	
	 <img src="static/picture/s201592317242.JPG" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-166.html" target="_blank">
	
	 <img src="static/picture/s201592411439.JPG" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-167.html" target="_blank">
	
	 <img src="static/picture/s2015924111155.JPG" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-168.html" target="_blank">
	
	 <img src="static/picture/s201564155252.jpg" border="0">
   ...
   <div class="newskx">
     <div class="newsx_pic"> 
	 <a href="detail-169.html" target="_blank">
	
	 <img src="static/picture/s201592411175.JPG" border="0">
   ...
   <div class="clearx"></div>
	...
	<!-- -->
	 <div id="p_pagex">
    <font face="webdings">7</font> <strong>[1]</strong> <a href='price-6_2_1.html'>[2]</a> <a href='price-6_3_1.html'>[3]</a> 页 <font face="webdings">8</font>1/3&nbsp;&nbsp;页面跳转：
                  <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
                      <option value="?class=6&page=1&section=1" selected="">1/3</option><option value="?class=6&page=2&section=1">2/3</option><option value="?class=6&page=3&section=1">3/3</option>
                  </select>
