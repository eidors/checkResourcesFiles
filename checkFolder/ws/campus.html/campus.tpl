...
<div id="overlay">  
   ...
   <!-- -->
	<div class="othersmenu fl">
       ...
       <div class="menu">
         <ul>
				   <li><a href="talent-17.html" class='tit'>人才战略</a></li>
				   <li><a href="talent-18.html" class='tit'>入职指南</a></li>
				   <li><a href="sociology.html" class='tit'>社会招聘</a></li>
				   <li><a href="" class='tit'>校园招聘</a></li>
				   <li><a href="internal.html" class='tit'>内部竞聘</a></li>
         </ul>
        </div>
    </div>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>校园招聘</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="javascript:;">人才招聘</a>&nbsp;&#8211;&nbsp;校园招聘</div>
        </div>
   ...
   <div class="clear"></div>
    ...
    <font face="webdings">7</font> <strong>[1]</strong> 页 <font face="webdings">8</font>1/1&nbsp;&nbsp;页面跳转：
                  <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
                      <option value="?t=&page=1&section=1" selected="">1/1</option>
                  </select>
    </div>
		</div>
