        ...
        <div id="mainc">
          ...
          <div class="newsk">
            <div class="news_pic">
              ...
              <img src="static/picture/s201692317241.jpg" border="0">
              
            </div>
            <div class="news_text">
              <div class="news_text_name">娲石水泥集团有限公司环境信息公开</div>
              <div class="news_text_detail"> <a href="javascript:;" target="_blank">
                2016年9月23日娲石水泥集团有限公司环境信息公开，点击此处查看更多内容……
                </a> </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div id="p_page">
            <font face="webdings">7</font> <a href='javascript:;'>[1]</a> <a href='news-2_2_1.html'>[2]</a> <strong>[3]</strong> 页 <font face="webdings">8</font>3/3&nbsp;&nbsp;页面跳转：
            <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
              <option value="?class=2&page=1&section=1">1/3</option><option value="?class=2&page=2&section=1">2/3</option><option value="?class=2&page=3&section=1" selected="">3/3</option>
            </select>
          </div>
        </div>
      </div>
