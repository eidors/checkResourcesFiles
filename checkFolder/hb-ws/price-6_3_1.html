...
<div id="overlay">  
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s201982184642.jpg" border="0">
   ...
   <div class="clearx"></div>
	...
	<!-- -->
	 <div id="p_pagex">
    <font face="webdings">7</font> <a href='javascript:;'>[1]</a> <a href='price-6_2_1.html'>[2]</a> <strong>[3]</strong> 页 <font face="webdings">8</font>3/3&nbsp;&nbsp;页面跳转：
                  <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
                      <option value="?class=6&page=1&section=1">1/3</option><option value="?class=6&page=2&section=1">2/3</option><option value="?class=6&page=3&section=1" selected="">3/3</option>
                  </select>
