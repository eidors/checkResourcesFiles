...
<div id="overlay">  
   ...
   <!-- -->
	<div class="othersmenu fl">
       ...
       <div class="menu">
         <ul>
				   ...
				   <li><a href="industry-10.html" class='tit'>阳新娲石水泥有限公司</a></li>
				   <li><a href="industry-11.html" class='tit'>阳新娲石商砼有限公司</a></li>
				   <li><a href="" class='tit'>阳新娲石建材有限公司</a></li>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>阳新娲石建材有限公司</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="#">集团产业</a>&nbsp;&#8211;&nbsp;<a href="#">阳新娲石建材有限公司</a></div>
        </div>
		
        <div id="mainc"><p style="text-indent:21pt" class="MsoNormal">
...
<p style="text-indent:21pt" class="MsoNormal">
	...
	<p class="MsoNormal" align="justify" style="text-indent:28.0000pttext-align:justify">
		<span style="font-size:16px">阳新娲石矿投新材料有限公司</span><span style="font-size:16px">成</span><span style="font-size:16px">立于</span><span style="font-size:16px">2020</span><span style="font-size:16px">年</span><span style="font-size:16px">3</span><span style="font-size:16px">月，位于阳新县富池镇郝矶村。成立初期阳新县为公司划定了</span><span style="font-size:16px">5400</span><span style="font-size:16px">亩的预留矿区，现拥有一条年产</span><span style="font-size:16px">1000</span><span style="font-size:16px">万吨绿色矿山高品质建材骨料生产线，</span><span style="font-size:16px">2020</span><span style="font-size:16px">年，黄石市批准建一条年产</span><span style="font-size:16px">2000</span><span style="font-size:16px">万吨绿色环保建材生产线，已列入了市重点项目，项目建成投产后，年生产能力将达到</span><span style="font-size:16px">3000</span><span style="font-size:16px">万吨。</span>
	</p>
	<p class="MsoNormal" style="text-indent:28.0000pt">
		<span style="font-size:16px">公司建设初期委托专业设计和施工单位精心布局，对产品质量实行全过程控制管理，各品种严格筛选分类存放，每小时采样跟踪监测产品品质，确保产品质量完全满足市场要求。骨料生产线采用目前国内先进的湿法生产工艺，全自动集中监控。污水、泥渣压滤分类处理，清水回收循环利用；石硝作为机制砂原材料利用；渣土用于矿山回填、恢复治理工程；矿山开采实现无粉尘、无污染物、无噪音；矿区实行边开采边复垦复绿，绿化面积达</span><span style="font-size:16px">30%</span><span style="font-size:16px">以上。</span>
	</p>
</span>
</p>
<p>
...
<p style="text-indent:24pt" class="MsoNormal" align="center">
	<img src="static/picture/20191009151492119211.png" width="800" height="357" alt=""> 
</p>
<p style="text-indent:24pt" class="MsoNormal" align="center">
	<img src="static/picture/20191009151424422442.JPG" width="800" height="600" alt=""> 
</p>
<p style="text-indent:24pt" class="MsoNormal" align="center">
	<span><img src="static/picture/20191009151532043204.png" width="800" height="524" alt="">&nbsp</span> 
</p>
<p style="text-indent:24pt" class="MsoNormal" align="center">
	&nbsp
</p>
