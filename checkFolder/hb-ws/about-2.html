...
<div id="overlay">  
   ...
   <!-- -->
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>总裁致辞</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="about-1.html">集团概况</a>&nbsp;&#8211;&nbsp;总裁致辞</div>
        </div>
		
        <div id="mainc"><p align="center">
	<p class="MsoNormal" style="text-align:lefttext-indent:28pt">
		<span style="font-size:18px">娲石集团一直秉承着</span><span style="font-size:18px">“为职工谋福祉，为社会做贡献”的责任，把“思路决定出路，人品铸就产品”的理念融入生产经营，</span>
	</p>
	<p class="MsoNormal" style="text-align:lefttext-indent:28pt">
		<span style="font-size:18px">把诚信做人、诚实做事作为立业之本。严以修身，俭以养德，花小钱办大事，用真情办实事。</span>
	</p>

<p style="text-align:center">
	<span style="font-size:18px"><img src="static/picture/20210423114039853985.jpg" width="800" height="498" alt=""><br>
</span> 
</p>
<p align="right" style="text-align:center">
	<span style="font-size:18px">集团董事长&nbsp 魏华山</span> 
</p>
<p>
	&nbsp
</p></div>
