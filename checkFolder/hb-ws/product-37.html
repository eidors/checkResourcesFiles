...
<div id="overlay">  
   ...
   <!-- -->
	<div class="othersmenu fl">
       ...
       <div class="menu">
         <ul>
				   <li><a href="product-12.html" class='tit'>联系我们</a></li>
				   <li><a href="product-14.html" class='tit'>售后服务</a></li>
				   <li><a href="product-15.html" class='tit'>经销加盟</a></li>
				   <li><a href="product-16.html" class='tit'>技术支持</a></li>
				   <li><a href="" class='tit'>留言中心</a></li>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>留言中心</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="product-12.html">联系我们</a>&nbsp;&#8211;&nbsp;留言中心</div>
        </div>
		
        <div id="mainc"><div class="maincontent">
<div class="aboutxt">
<h5 class="tit"></h5>
<p style="float:right">
</p>
...
<form action="save.asp" method="post" name="Frm" id="Frm" onsubmit="return check_input()">
...
{  
	...
	if (Frm.guestcontent.value=="")
	{   alert("错误提示：请填写留言内容！！ ");
		return false;
	}
	if (Frm.getcode2.value=="")
	{   alert("错误提示：请填写正确的验证码！！ ");
		return false;
	}
}
                                </script>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   <td colspan="2">欢迎您的访问！如果您有任何的问题、建议或要求，请与我们分享；我们将不断改进我们的产品技术、工艺流程和服务质量，不遗余力地为您的工作和生活提供更好、更多的产品和服务！ 我们感谢您提供尊贵的意见！
</td>
                   </tr>
                 <tr>
                   <td width="10%" height="35" align="right">姓　　名：</td>
                   <td width="90%"><input name="guestname" type="text" id="guestname"></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   <td height="35" align="right">电话/手机：</td>
                   <td><input name="tel" type="text" id="tel"></td>
                 </tr>
                 <tr>
                   <td height="35" align="right">验 证 码：</td>
                   <td><input name="getcode2" type="text" id="getcode2" size="8" maxlength="4">
                     <img src="static/picture/getcode.jpg" alt="验证码为：数字0-9和字母AGYCT的组合！
不区分大小写！" align="absmiddle" style="cursor : pointer;" onclick="this.src='getcode.asp'"></td>
                 </tr>
                 <tr>
                   <td height="35" align="right">留言内容：</td>
                   <td><textarea name="guestcontent" cols="69" rows="10" id="guestcontent"></textarea></td>
                 </tr>
                 <tr>
                   <td>&nbsp;</td>
                   <td height="40"><input name="image" type="image" src="../images/botton4.jpg">
       <input name="Submit22" type="image" src="../images/botton5.jpg" onclick="javascript:document.forms['Frm'].reset(); return false;"></td>
                 </tr>
               </table></form>
</div>
</div>
