...
<div id="overlay">  
   ...
   <!-- -->
	<div class="othersmenu fl">
       ...
       <div class="menu">
         <ul>
				   <li><a href="price-14831_6.html" class='tit'>成功案例</a></li>
    ...
    <div class="othersmain business-brandactiv fr">
        <div class="other-titles">
          <h2>成功案例</h2>
        <div class="fr location"><a href="index.html">首页</a>&nbsp;&#8211;&nbsp;<a href="price-14831_6.html">产品服务</a>&nbsp;&#8211;&nbsp;成功案例</div>
        </div>
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s2015923152323.JPG" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s2015924112031.JPG" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s2015924112327.JPG" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s201982181454.jpg" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s201982182332.jpg" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s201982182130.jpg" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s201982181910.jpg" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s201982182951.jpg" border="0">
   ...
   <div class="newskx">
	 ...
	 <img src="static/picture/s201982183346.jpg" border="0">
   ...
   <div class="clearx"></div>
	...
	<!-- -->
	 <div id="p_pagex">
    <font face="webdings">7</font> <a href='javascript:;'>[1]</a> <strong>[2]</strong> <a href='price-6_3_1.html'>[3]</a> 页 <font face="webdings">8</font>2/3&nbsp;&nbsp;页面跳转：
                  <select name="class" id="class" style="width:60px" onchange="location=''+this[this.selectedIndex].value+''">
                      <option value="?class=6&page=1&section=1">1/3</option><option value="?class=6&page=2&section=1" selected="">2/3</option><option value="?class=6&page=3&section=1">3/3</option>
                  </select>
